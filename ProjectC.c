...
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"mahakal Express","piyush Express","ashok Express","pramila Express","pradeep Express","vinay Express"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
return 0;
    ...
    printf("\t----------------------------------------------------------------------------------------------------------\n");
    printf("\t\t\t hii piyush chirote here");
    getch();
    return 0;
}
    ...
    do
{
	...
	i=0;
	//scanf("%s",&pword); 
		if(strcmp(uname,"piyush")==0 && strcmp(pword,"6453")==0)
	{
